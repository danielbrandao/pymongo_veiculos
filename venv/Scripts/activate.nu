...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Daniel\PycharmProjects\pythonFlaskMongov1\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Daniel\PycharmProjects\pythonFlaskMongov1\venv\Scripts\deactivate.nu'
